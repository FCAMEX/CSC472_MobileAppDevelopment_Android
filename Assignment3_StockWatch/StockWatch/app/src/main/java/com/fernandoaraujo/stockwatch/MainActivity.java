...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnLongClickListener {
    ...
    private static final String apiToken = "sk_5fc3112a59584a93b3bef74e92aa6a60";
    private List<Stock> stockList = new ArrayList<>();
    private HashMap<String, String> tempStockHash = new HashMap<String, String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!connected) {
            showNoNetworkPopUp("UPDATE");

            for(String symbol: tempStockHash.keySet()){
                Stock temp = new Stock(symbol, tempStockHash.get(symbol));
                stockList.add(temp);
            }
            ...
            new NameDownloader_AsyncTask().execute();
    ...
    private void processAddInput(String input) {
        ...
        final List<String> matchingList = NameDownloader_AsyncTask.matchInput(input);
    ...
    public void showNoNetworkPopUp(String mode) {
    ...
    public void handleStockReturn(String mode, Stock s) {
