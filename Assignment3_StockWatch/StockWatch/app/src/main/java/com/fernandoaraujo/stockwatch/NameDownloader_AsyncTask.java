...
public class NameDownloader_AsyncTask extends AsyncTask<String, Void, String> {

    private static final String TAG = "NameDownloader_AsyncTas";
    ...
    public static List<String> matchInput(String input){
